...
/// </summary>
public class TriggerChangingColor : MonoBehaviour
{
    void OnTriggerEnter(Collider other)
    {
        ...
        {
            transform.parent.GetComponent<GameManager>().TriggerColorChangingCBLUE(this);
        }
        ...
        {
            transform.parent.GetComponent<GameManager>().TriggerColorChangingBBLUE(this);
        }
        ...
        {
            transform.parent.GetComponent<GameManager>().TriggerColorChangingCYBLUE(this);
        }
